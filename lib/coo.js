...
// ── CHECK-IN (midday / 4pm) ────────────────────────────────────────────────
export async function generateCheckin({ type, tasks, schedule, userMessage, llmKeys = {} }) {
...
// ── EVENING RETRO ─────────────────────────────────────────────────────────────
export async function generateEveningRetro({ tasks, schedule, roadmap, incompleteTasks = [], llmKeys = {} }) {
...
// ── WEEKLY REVIEW ─────────────────────────────────────────────────────────────
export async function generateWeeklyReview({ weekTasks, roadmap, llmKeys = {} }) {
  const byCategory = {}
  weekTasks.forEach(t => {
...
export async function generateRelationshipBrief({ contacts, overdueContacts, upcomingBirthdays, userMessage, weeklyCheckin, llmKeys = {} }) {
