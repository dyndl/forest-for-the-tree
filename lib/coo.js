...
// ── FREE-FORM CHAT ────────────────────────────────────────────────────────────
export async function generateChatResponse({ userMessage, tasks, schedule, userCtx }) {
...
Respond ONLY with JSON (no fences):
{
  "message": "Your COO response — direct, warm, max 4 sentences. Use today's context if relevant.",
